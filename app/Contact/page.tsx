...
export default function ContactPage() {
  ...
  return (
    <div className="w-full min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="text-green-600 py-20 text-center bg-linear-to-b from-green-50 to-white">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">Contact Us</h1>
        <p className="text-lg md:text-xl text-gray-600">
          We’d love to hear from you! Reach out for any questions, feedback, or
          support.
        </p>
      </section>
      ...
      <section className="py-16 px-6 max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
        ...
        <div className="bg-white p-8 rounded-3xl shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full bg-linear-to-r from-green-400 to-green-500 text-white font-bold py-3 rounded-2xl shadow-md hover:from-green-500 hover:to-green-600 transition"
            >
              Send Message
            </button>
          </form>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-2xl space-y-4">
            ...
            <p>
              <span className="font-semibold">Address:</span> 123 Foodes Street,
