...
export default function FoodBanner() {
  return (
    <div className="relative rounded-lg mt-3 w-full h-120 md:h-500px flex items-center justify-center text-center bg-gradient-to-r from-yellow-400 via-red-400 to-pink-500 overflow-hidden">
      <Image
        src={banner}
        alt="Delicious food"
        fill
